...
<html>
    ...
    <body>
        ...
        <div id="main" class="shell">
            ...
            <div id="content">
                <center>
                    <div style="color: teal; font-size: 30px">CB BookStore | Employee Details</div>
                    <br /> <br /> <br /> 
                        ...
                        <table border="1" bgcolor="black" width="500px" style="font-size: 15px; ">
                            ...
                            <c:forEach items="${employeeList}" var="employee">
                                <tr
                                    ...
                                    <td><a href="admin_employee_edit?id=${employee.id}">Edit</a></td>
                                    <td><a href="admin_employee_delete?id=${employee.id}">Delete</a></td>
                                </tr>
                            </c:forEach>
                        </table>
                    </c:if>
                    ...
                    <br />
                    <a href="admin_employee_form" style="font-size: 15px; ">Click Here to add new Employee</a>
                </center>
            </div>
            <!-- End Content -->
            <div class="cl">&nbsp;</div>
