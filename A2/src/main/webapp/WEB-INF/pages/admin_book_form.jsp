        ...
        <div id="main" class="shell">
            ...
            <div id="content">
                ...
                <div class="post">
                    <div class="entry">
                        <center>
                            <div style="color: teal; font-size: 30px">CB BookStore | Registration Form</div>
                            <br />
                            <c:url var="bookRegistration" value="saveBook.html" />
                            <form:form id="registerForm" modelAttribute="book" method="post"
                                       action="admin_book_register">
                                <table width="400px" height="150px" style="font-size: 15px">
                                    <tr>
                                        <td><form:label path="title">Title</form:label></td>
                                        <td><form:input path="title" style="font-size: 15px"/></td>
                                    </tr>
                                    <tr>
                                        <td><form:label path="author">Author</form:label></td>
                                        <td><form:input path="author" style="font-size: 15px"/></td>
                                    </tr>
                                    <tr>
                                        <td><form:label path="genre">Genre</form:label></td>
                                        <td><form:input path="genre" style="font-size: 15px"/></td>
                                    </tr>
                                    <tr>
                                        <td><form:label path="quantity">Quantity</form:label></td>
                                        <td><form:input path="quantity" style="font-size: 15px"/></td>
                                    </tr>
                                    <tr>
                                        <td><form:label path="price">Price</form:label></td>
                                        <td><form:input path="price" style="font-size: 15px"/></td>
                                    </tr>

                                    <tr>
                                        <td></td>
                                        <td><input type="submit" value="Register" style="font-size: 15px"/>
                                        </td>
                                    </tr>
                                </table>
                            </form:form>
                            <a href="admin_book_list" style="font-size: 15px">Click Here to see Book List</a>
                        </center>
                    </div>                              
                </div>
