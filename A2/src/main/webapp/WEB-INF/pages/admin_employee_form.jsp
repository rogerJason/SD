...
<html>
    <head>
        ...
        <title>CB BookStore | Employees</title>
                    ...
                    <div class="entry">
                        <center>
                            ...
                            <form:form id="registerForm" modelAttribute="employee" method="post"
                                       action="admin_employee_register">
                                <table width="400px" height="150px" style="font-size: 15px">
                                    <tr>
                                        <td><form:label path="firstName">First Name</form:label></td>
                                        <td><form:input path="firstName" style="font-size: 15px"/></td>
                                    </tr>
                                    <tr>
                                        <td><form:label path="lastName">Last Name</form:label></td>
                                        <td><form:input path="lastName" style="font-size: 15px"/></td>
                                    </tr>
                                    <tr>
                                        <td><form:label path="income">Income</form:label></td>
                                        <td><form:input path="income" style="font-size: 15px"/></td>
                                    </tr>
                            ...
                            <a href="admin_employee_list" style="font-size: 15px">Click Here to see Employee List</a>
                        </center>
                    </div>                              
                </div>
