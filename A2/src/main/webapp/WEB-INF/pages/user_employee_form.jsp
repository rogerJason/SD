...
<html>
    <head>
        ...
        <title>CB BookStore | Registration</title>
    ...
    <body>
        <div id="wrapper">
            <div id="header">
                <div id="logo">
                    <h1><a href="home">CB BookStore</a></h1>
                </div>
                <div id="search">
                            ...
                            <div class="post">
                                ...
                                <div class="entry">
                                    <center>
                                        ...
                                        <br />
                                        <c:url var="employeeRegistration" value="saveClient.html" />
                                        <form:form id="registerForm" modelAttribute="employee" method="post"
                                                   action="user_employee_register">
