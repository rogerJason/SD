            ...
            <div class="container">
                ...
                <div id="navbar" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="${pageContext.request.contextPath}/admin/list">User Accounts</a></li>
                    </ul>
                </div><!--/.nav-collapse -->
            </div>
        </nav>
            ...
            <c:if test="${!empty userAccountList}">
                <table class="table table-striped">
                    ...
                    <c:forEach items="${userAccountList}" var="userAccount">
                        <tbody>
                            <tr>
                                <td><c:out value="${userAccount[1].username}" />
                                </td>
                                <td><c:out value="${userAccount[1].password}" />
                                </td>
                                <td><c:out value="${userAccount[0].role}" />
                                </td>

                                <td><a href="${pageContext.request.contextPath}/admin/edit?id=${userAccount[0].userRoleId}">Edit</a></td>
                            </tr>
                        </tbody>
                    </c:forEach>
                </table>
